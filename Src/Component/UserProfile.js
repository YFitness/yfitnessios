...
const Styles = StyleSheet.create({
    e: {
        color: '#fcb72b', fontSize: 15,          textAlign: 'center', textAlignVertical: 'center'
    },
    container: {
        backgroundColor: '#1a1a1a', padding: 15, marginTop: 10
    }, Text: { color: '#fcb72b', fontSize: 15, alignSelf: 'center', marginTop: 5,          width: '90%', textAlign: 'center' }
    , NumberTxt: {
